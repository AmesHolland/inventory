<template>
  <div>
    ...
    <el-table
      ...
      <el-table-column prop="deId" label="出货仓库"></el-table-column>
      <el-table-column prop="remark" label="备注"></el-table-column>
      <el-table-column label="审核" width="400" align="center">
        <template slot-scope="scope" >
          <el-button type="primary"  @click="$router.push('/sale_order_detail?id='+ scope.row.id)">修改/查看订单详情<i class="el-icon-edit"></i></el-button>
          <span v-if="!scope.row.isOut">
            <el-popconfirm
                class="ml-5"
